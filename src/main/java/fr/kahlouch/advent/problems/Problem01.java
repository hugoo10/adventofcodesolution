...
public class Problem01 extends Problem {
    final List<Elf> elfos = new ArrayList<>();
    ...
    static class Elf implements Comparable<Elf> {
        ...
        public int compareTo(Elf elfo) {
            return this.totalCalories - elfo.totalCalories;
        }
    ...
    public void setupData() {
        Elf elfo = null;
        for (var idx = 0; idx < this.lines.size(); ++idx) {
            ...
            final var calories = Integer.parseInt(line);
            elfo.addCalories(calories);
        }
    ...
    */
    @Override
    public Object rule1() {
        return new TreeSet<>(this.elfos).last().totalCalories;
    }
